...
public class ProductService {
    ...
    public Page<ProductResponse> getProductsByCategoryId(Long categoryId, int page, int size) {
        ...
        collectDescendantCategoryIds(category.getId(), categoryIds);
    ...
    private void collectDescendantCategoryIds(Long categoryId, List<Long> accumulator) {
        ...
        for (Category child : children) {
            collectDescendantCategoryIds(child.getId(), accumulator);
        }
    }
}
